...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            "h-10 px-2 text-left align-middle text-xs font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 sm:px-4",
            className,
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={cn(
            "h-12 px-2 align-middle text-sm [&:has([role=checkbox])]:pr-0 sm:px-4",
            className,
        )}
        {...props}
    />
